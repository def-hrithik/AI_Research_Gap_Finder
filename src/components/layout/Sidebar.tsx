...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const projectLinks = projectId
    ? [
        ...
        {
          to: `/projects/${projectId}/landscape`,
          icon: Map,
          label: 'Landscape',
        },
        {
  ...
  return (
    ...
    >
      ...
      <Link
        to="/"
        className="h-16 flex items-center px-4 border-b border-border overflow-hidden shrink-0 hover:bg-surface-raised transition-colors"
      >
        ...
        {!collapsed && (
          <span className="ml-3 font-bold text-lg text-primary tracking-tight truncate">
            Nexus Gap Finder
          </span>
        )}
      </Link>
      ...
      <div className="flex-1 overflow-y-auto py-6 px-3 flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-1">
          {!collapsed && (
            <span className="px-3 text-xs font-semibold text-secondary uppercase tracking-wider mb-2">
              Platform
            </span>
          )}
